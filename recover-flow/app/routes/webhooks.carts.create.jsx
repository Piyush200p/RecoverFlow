/**
 * RecoverFlow AI — Webhook: carts/create
 * =============================================
 * Receives Shopify cart creation events and forwards
 * the payload to the FastAPI backend for cart abandonment processing.
 */
...
export const action = async ({ request }) => {
  ...
  try {
    ...
    const response = await fetch(`${backendUrl}/webhooks/cart-abandonment`, {
      method: "POST",
      headers: {
